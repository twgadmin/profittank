                    ...
                    <div class="tab">
                        <div class="row justify-content-center">
                            <div class="col-md-5">
                                <div class="fld-upload">
                                    <label for="upload02">
                                        <input type="file" name="Upload_Waste_Invoices_Statements_(3_months)" id="upload02" oninput="this.className = ''">
                                        <span>
                                            <figure><img src="{!! asset('assets/frontend/website/assets/images/icons/upload.svg') !!}" alt="" class="w-25"></figure>
                                            <h6>{!! getChannelQuestions('Upload_Waste_Invoices_Statements_(3_months)') !!}</h6>
                                            <p id="uploadeText2"></p>
                                        </span>
                                    </label>
                                </div>
...
<script>        
    ...
    function showTab(n) {
        ...
        if (n == (x.length - 1)) {
            ...
            $("#nextBtn").attr("onclick", "FileTypevalidateEP('upload02')");
        } else {
