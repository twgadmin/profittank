...
@section('page-title', 'Workers COMP')
<!-- page content  -->
@section('content')
<div id="render">
                    ...
                    <div class="tab">
                        <div class="row justify-content-center">
                            <div class="col-md-5">
                                <div class="fld-upload">
                                    <label for="upload02">
                                        <input type="file" name="Upload_Workers_Comp_Audits_(past_3_years)" id="upload02" oninput="this.className = ''">
                                        <span>
                                            <figure><img src="{!! asset('assets/frontend/website/assets/images/icons/upload.svg') !!}" alt="" class="w-25"></figure>
                                            <h6>{!! getChannelQuestions('Upload_Workers_Comp_Audits_(past_3_years)') !!}</h6>
                                            <p id="uploadeText2"></p>
                                        </span>
                                    </label>
                                </div>
                    ...
                    <div class="tab">
                        <div class="row justify-content-center">
                            <div class="col-md-5">
                                <div class="fld-upload">
                                    <label for="upload03">
                                        <input type="file" name="Upload_Audit_worksheets_(past_3_years)" id="upload03" oninput="this.className = ''">
                                        <span>
                                            <figure><img src="{!! asset('assets/frontend/website/assets/images/icons/upload.svg') !!}" alt="" class="w-25"></figure>
                                            <h6>{!! getChannelQuestions('Upload_Audit_worksheets_(past_3_years)') !!}</h6>
                                            <p id="uploadeText3"></p>
                                        </span>
                                    </label>
                                </div>
                    ...
                    <div class="tab">
                        <div class="row justify-content-center">
                            <div class="col-md-5">
                                <div class="fld-upload">
                                    <label for="upload04">
                                        <input type="file" name="Upload_Loss_runs_for_(past_3_years)" id="upload04" oninput="this.className = ''">
                                        <span>
                                            <figure><img src="{!! asset('assets/frontend/website/assets/images/icons/upload.svg') !!}" alt="" class="w-25"></figure>
                                            <h6>{!! getChannelQuestions('Upload_Loss_runs_for_(past_3_years)') !!} </h6>
                                            <p id="uploadeText4"></p>
                                        </span>
                                    </label>
                                </div>
...
<script>        
    ...
    function showTab(n) {
        ...
        if (n == (x.length - 1)) {
            ...
            $("#nextBtn").attr("onclick", "FileTypevalidateEP('upload04')");
        } else {
