...
@section('page-title', 'Merchant Processing')
<!-- page content  -->
@section('content')
<div id="render">
                ...
                <form id="activateForm" class="w-100" method="POST"  action="{!! route('activate-channel-submit') !!}" enctype="multipart/form-data">
                    ...
                    <div class="tab">
                        <div class="row justify-content-center">
                            <div class="col-md-5">
                                <div class="fld-input">
                                    <label for="">{!! getChannelQuestions('What_type_of_merchant_processing_softwares_do_you_use') !!} </label>
                                    <input type="text" name="What_type_of_merchant_processing_softwares_do_you_use" oninput="this.className = ''">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="tab">
                        <div class="row justify-content-center">
                            <div class="col-md-5">
                                <div class="fld-input">
                                    <label for="">{!! getChannelQuestions('Are_you_under_contract') !!}</label>
                                    <div class="row fld-radio">
                                        <div class="col-md-4">
                                            <label for="yes1">
                                                <input type="radio" name="Are_you_under_contract" id="yes1" value="yes" oninput="this.className = ''">
                                                <span>Yes</span>
                                            </label>
                                        </div>
                                        <div class="col-md-4">
                                            <label for="no1">
                                                <input type="radio" name="Are_you_under_contract" id="no1" value="no" oninput="this.className = ''">
                                                <span>No</span>
                                            </label>
                                        </div>
                                        <div class="col-md-4">
                                            <label for="unknown1">
                                                <input type="radio" name="Are_you_under_contract" value="Unknown"  id="unknown1" oninput="this.className = ''">
                                                <span>Unknown</span>
                                            </label>
                                        </div>
                                    </div>
                    ...
                    <div class="tab">
                        <div class="row justify-content-center">
                            <div class="col-md-5">
                                <div class="fld-input">
                                    <label for="">{!! getChannelQuestions('When_does_your_contract_end') !!}</label>
                                    <input type="date" name="When_does_your_contract_end" oninput="this.className = ''">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-5">
                                <div class="fld-upload">
                                    <label for="upload0">
                                        <input type="file" name="Upload_Merchant_Processing_Statements(3_months)" id="upload0" oninput="this.className = ''">
                                        <span>
                                            <figure><img src="{!! asset('assets/frontend/website/assets/images/icons/upload.svg') !!}" alt="" class="w-25"></figure>
                                            <h6>{!! getChannelQuestions('Upload_Merchant_Processing_Statements(3_months)') !!}</h6>
                                            <p id="uploadeText0"></p>
                                        </span>
                                    </label>
                                </div>
