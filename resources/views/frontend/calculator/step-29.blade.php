...
<section class="tevantenine revenue_slides row align-items-center">
    <div class="col-12 col-lg-8 mx-auto">
        <div class="hedingthr">
            <h3 class="text-center  mb-5">What are your monthly phone expenses?
            </h3>
            <div class="government m-auto">
                <div class="form-group">
                    <div class="form__field">
                        <span class="next-slide-button {{session()->get('phone_expense') !='' ? 'active' : '' }}" id="revenueNext"><img
                                src="{!! asset('/assets/images/front/left1.png') !!}"></span>
                        <input type="text" autocomplete="off" class="form-control numberWithCurrency"
                            name="phone_expense" id="exampleInputEmail1" aria-describedby="emailHelp"
                            placeholder="$ phone expenses" value="{{session()->get('phone_expense')}}"
                            data-message='Please enter a whole number between "15" and "80,000".'
                            data-validation="custom required length" data-validation-length="15-80000" />
                    </div>
                </div>
            </div>
        </div>
