...
<section class="fiftin revenue_slides row align-items-center">
    <div class="col-12 col-lg-8 mx-auto">
        <div class="hedingthr">
            <h3 class="text-center  mb-5">
                Estimate the real property value of your </br> commercial real estate holdings. </h3>
            <div class="government m-auto" style="max-width: 275px;">
                <div class="form-group">
                    <div class="form__field">
                        <span class="next-slide-button {{session()->get('property_value') !='' ? 'active' : '' }}" id="revenueNext"><img
                                src="{!! asset('/assets/images/front/left1.png') !!}"></span>
                        <input type="text" autocomplete="off" class="form-control numberWithCurrency"
                            name="property_value" id="exampleInputEmail1" aria-describedby="emailHelp"
                            placeholder="$ real property value" value="{{session()->get('property_value')}}"
                            data-message='Please enter a whole number between "750,000" and "100,000,000".'
                            data-validation="custom required length" data-validation-length="750000-100000000" />
                    </div>
                </div>
            </div>
        </div>
