...
<section class="sixtin revenue_slides row align-items-center">
    <div class="col-12 col-lg-8 mx-auto">
        <div class="hedingthr">
            <h3 class="text-center  mb-5">
                Estimate what you paid most recently <br> in commercial property taxes.</h3>
            <div class="government m-auto">
                <div class="form-group">
                    <div class="form__field">
                        <span class="next-slide-button {{session()->get('recent_tax') !='' ? 'active' : '' }}" id="revenueNext"><img
                                src="{!! asset('/assets/images/front/left1.png') !!}"></span>
                        <input type="text" autocomplete="off" class="form-control numberWithCurrency" name="recent_tax"
                            id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="$ real estate taxes"
                            value="{{session()->get('recent_tax')}}" data-message='Please enter a whole number between "5,000" and "10,000,000".'
                            data-validation="custom required length" data-validation-length="5000-10000000" />
                    </div>
                </div>
            </div>
        </div>
