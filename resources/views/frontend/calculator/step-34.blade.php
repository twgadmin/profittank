...
<section class="tertinefore revenue_slides row align-items-center">
    <div class="col-12 col-lg-8 mx-auto">
        <div class="hedingthr">
            <h3 class="text-center  mb-5">What percent of your total small parcel shipments </br> are domestic delivery?
            </h3>
            <div class="government m-auto">
                <div class="form-group">
                    <div class="form__field">
                        ...
                        <span class="next-slide-button {{session()->get('parcel_per') == 'Yes' ? 'checked' : ''}}" id="revenueNext">
