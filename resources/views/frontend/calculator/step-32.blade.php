...
<section class="threentwo revenue_slides row align-items-center">
    <div class="col-12 col-lg-8 mx-auto">
        <div class="threechexk">
            <h3 class="mb-5">Do you spend at least $50,000 annually in small parcel </br> shipping (packages, boxes,
                envelopes)? </h3>
            <div class="custom-choose mb-5 mt-5">
                <input type="radio" class='radio_next' id="boxes-1" value="Yes" name="spent_in_shipping"
                    {{session()->get('spent_in_shipping') == 'Yes' ? 'checked' : ''}}>
                <label for="boxes-1">
                    Yes
                </label>
                <input type="radio" class='radio_next' id="boxes-2" value="No" name="spent_in_shipping"
                    {{session()->get('spent_in_shipping') == 'No' ? 'checked' : ''}}>
                <label for="boxes-2">
                    No
                </label>
                <input type="radio" class='radio_next' id="boxes-3" value="Unknown" name="spent_in_shipping"
                    {{session()->get('spent_in_shipping') == 'Unknown' ? 'checked' : ''}}>
                <label for="boxes-3">
                    Unknown
                </label>
            </div>
            <div class="form__field form__field_select_choose">
                <input type="hidden" id="option_value"
                    value="{{session()->get('spent_in_shipping')}}" data-validation="custom required"
