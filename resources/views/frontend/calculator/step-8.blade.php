...
<div class="eight revenue_slides row align-items-center">
    <div class="col-12 col-lg-8 mx-auto">
        <div class="hedingthr">
            <h3 class="text-center  mb-5">Enter your total number of </br> full time and part time employees.</h3>
            <div class="government m-auto">
                <div class="form-group">
                    <div class="form__field">
                        <span class="next-slide-button {{session()->get('total_emp') !='' ? 'active' : '' }}" id="revenueNext"><img
                                src="{!! asset('/assets/images/front/left1.png') !!}"></span>
                        <input type="text" autocomplete="off" name="total_emp" class="form-control numberonly"
                            value="{{session()->get('total_emp')}}" id="option_value" aria-describedby="emailHelp"
                            placeholder="# of employees" data-message="Please enter a whole number
    between 1 and 2,200,000" data-validation="custom required length" data-validation-length="1-2200000" />
                    </div>
                </div>
            </div>
        </div>
