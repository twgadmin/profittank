...
<section class="forteen revenue_slides row align-items-center">
    <div class="col-12 col-lg-8 mx-auto">
        <div class="hedingthr">
            <h3 class="text-center  mb-5">For your medical waste, enter your<br> total monthly expense.
            </h3>
            <div class="government m-auto" style="    max-width: 295px !important;">
                <div class="form-group">
                    <div class="form__field">
                        <span class="next-slide-button {{session()->get('medical_expense') != '' ? 'active' : ''}}" id="revenueNext"><img
                                src="{!! asset('/assets/images/front/left1.png') !!}"></span>
                        <input type="text" autocomplete="off" class="form-control numberWithCurrency"
                            name="medical_expense" id="exampleInputEmail1" aria-describedby="emailHelp"
                            placeholder="$ medical waste expense" value="{{session()->get('medical_expense')}}"
                            data-message='Please enter a whole number between "5" and "1,000,000".'
                            data-validation="custom required length" data-validation-length="5-1000000" />
                    </div>
                </div>
            </div>
        </div>
