...
<div class="forth revenue_slides row align-items-center">
    <div class="col-12 col-lg-8 mx-auto">
        <div class="hedingthr">
            <h3 class="text-center  mb-5">Estimate your total annual business expenses.</h3>
            <div class="government m-auto">
                <div class="form-group">
                    <div class="form__field">
                        <span class="next-slide-button {{session()->get('annual_expenses') !='' ? 'active' : '' }}" id="revenueNext"><img
                                src="{!! asset('/assets/images/front/left1.png') !!}"></span>
                        <input type="text" autocomplete="off" name="annual_expenses"
                            value="{{session()->get('annual_expenses')}}" class="form-control numberWithCurrency"
                            id="option_value" aria-describedby="emailHelp" placeholder="$ annual expenses"
