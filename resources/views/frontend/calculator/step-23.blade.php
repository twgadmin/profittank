...
<section class="tevantethree revenue_slides row align-items-center">
    <div class="col-12 col-lg-8 mx-auto">
        <div class="hedingthr">
            <h3 class="text-center  mb-5">How many employees do you have on payroll?</h3>
            <div class="government m-auto">
                <div class="form-group">
                    <div class="form__field">
                        <span class="next-slide-button {{session()->get('current_emp') !='' ? 'active' : '' }}" id="revenueNext"><img
                                src="{!! asset('/assets/images/front/left1.png') !!}"></span>
                        <input type="text" autocomplete="off" class="form-control numberonly" name="current_emp"
                            id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="# of employees"
                            value="{{session()->get('current_emp')}}"
                            data-message='Please enter a whole number between "1" and "2,200,000".'
                            data-validation="custom required length" data-validation-length="1-2200000" />
                    </div>
                </div>
            </div>
        </div>
