...
<section class="tertinenine revenue_slides row align-items-center">
    <div class="col-12 col-lg-8 mx-auto">
        <div class="hedingthr">
            <h3 class="text-center  mb-5">Estimate your number of medical waste<br> containers per pickup.
            </h3>
            <div class="government m-auto">
                <div class="form-group">
                    <div class="form__field">
                        <span class="next-slide-button {{session()->get('container') != '' ? 'active' : ''}}" id="revenueNext"><img
                                src="{!! asset('/assets/images/front/left1.png') !!}"></span>
                        <input type="text" autocomplete="off" class="form-control numberonly" name="container"
                            id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="# of containers"
